...
### How can you do this project for yourself?

1. Clone or visit this [link](https://github.com/udacity/mws-restaurant-stage-1.git) to download the github repository. Start up a simple HTTP server to serve up the site files on your local computer. Python has some simple tools to do this, and you don't even need to know Python. For most people, it's already installed on your computer.
